...
export const Projects = () => {
  return (
    <div className='projects' id='projects'>
      <h1>Proyectos</h1>
      <h3>Echa un vistazo a mis últimos proyectos</h3>
